...
const audioInstance = new Audio(
  'https://sagantosu-uploaded-files.s3.ap-northeast-1.amazonaws.com/public/John_Bartmann_-_09_-_Happy_Clappy-1.mp3'
)
...
export const UserMenu = () => {
  ...
  const [audioIcon, setAudioIcon] = React.useState(<MusicNote />)
